(() => {
  ...
  const copy = {
    cs: {
      eyebrow: "Data · 44 zemí · 15 vrstev", title: "Jak čerstvá jsou data napříč celým webem?",
      ...
      selected: "Vybraná vrstva", firstYear: "Začátek řady", entities: "Jednotky / řady", actual: "skutečnost / statistika",
      ...
      planned: "plán", live_register: "živý registr", mixed_current: "aktuální mix", mixed_lag: "starší mix", undated: "bez roku",
    ...
    en: {
      eyebrow: "Data · 44 countries · 15 layers", title: "How fresh is the data across the whole site?",
      ...
      selected: "Selected layer", firstYear: "Series start", entities: "Entities / series", actual: "actual / statistical",
      ...
      planned: "plan", live_register: "live register", mixed_current: "current mix", mixed_lag: "older mix", undated: "undated",
