(() => {
  const T = {
    cs: {
      ...
      flowKicker:"05 / Zdravotnictví",flowTitle:"Jeden systém.<br>Tři rozpočty.",flowIntro:"Zdravotnictví není jediná rozpočtová kapitola. Pojistné, státní platby, úhrady pojišťoven a hospodaření nemocnic jsou propojené, ale každý celek má jiný rozsah i účetní rok.",
      ...
      benchKicker:"06 / Benchmark nemocnic",benchTitle:"Každá nemocnice.<br>Ve správném srovnání.",benchIntro:"Vyberte veřejně ovládanou nemocnici s dostupným výkazem za rok 2024. Výsledek porovnáváme s podobně velkými organizacemi nebo se stejnou úrovní zřizovatele.",
    ...
    en: {
      ...
      flowKicker:"05 / Healthcare",flowTitle:"One system.<br>Three budgets.",flowIntro:"Healthcare is not a single budget chapter. Premiums, state payments, insurer reimbursements and hospital accounts are connected, but each layer has a different scope and reporting year.",
      ...
      benchKicker:"06 / Hospital benchmark",benchTitle:"Every hospital.<br>The right peers.",benchIntro:"Select a publicly controlled hospital with an available 2024 statement. Compare it with organisations of a similar size or with the same level of public owner.",
