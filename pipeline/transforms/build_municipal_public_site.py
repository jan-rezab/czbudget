...
def build_directory(data: dict) -> None:
    ...
    page_head = head('Rozpočty všech obcí a krajů ČR 2010–2025', 'Historický vývoj příjmů, výdajů, výsledku hospodaření, stavu účtů a výdajů na obyvatele všech 6 254 obcí.', '/cz/obce/', 2, schema).replace('cz-budget.css"', 'cz-budget.css?v=20260822-spending-benchmark"')
...
</main>{footer('../../')}<script src="../../municipal-i18n.js?v=20260822-spending-benchmark" defer></script><script src="../../cz-municipal-directory.js?v=20260822-spending-benchmark" defer></script></body></html>\n""", encoding="utf-8")
