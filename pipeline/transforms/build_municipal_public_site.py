...
def build_directory(data: dict) -> None:
    ...
    schema = {
        ...
        "description": "Historické příjmy, výdaje, výsledek hospodaření a stav účtů 6 254 českých obcí; doplněno o snapshot krajů za rok 2025.",
    ...
    page_head = head('Rozpočty všech obcí a krajů ČR 2010–2025', 'Historický vývoj příjmů, výdajů, výsledku hospodaření a stavu účtů všech 6 254 obcí. Praha je v součtu s kraji započtena jen jednou.', '/cz/obce/', 2, schema).replace('cz-budget.css"', 'cz-budget.css?v=20260822-history-explorer"')
...
<section class="directory" id="subjekty"><div class="directory-title"><div><span class="kicker">04 / Všechny obce · <b id="municipality-directory-year">2025</b></span><h2>Najděte libovolnou obec.</h2></div><p>Jednotná data FIN 2-12 M a rozvahy pro vybraný rok. Stav účtů nezahrnuje samostatné příspěvkové organizace.</p></div>
...
<section class="data-contract" id="metodika"><div><span class="kicker">05 / Definice</span><h2>Výsledek i stav účtů.</h2><p>Výsledek = skutečné příjmy po konsolidaci minus skutečné výdaje po konsolidaci. Stav účtů je součet účtů 068, 231, 236, 241, 244, 261 a 262 v rozvaze obce.</p></div><div class="source-list"><a href="../../data/municipal-history-directory.v1.json"><span>Historický adresář</span><strong>JSON · 2010–2025 ↗</strong></a><a href="../../data/municipal-snapshot.v1.json"><span>Kompletní snapshot</span><strong>JSON · 2025 ↗</strong></a><a href="https://monitor.statnipokladna.gov.cz/datovy-katalog/" target="_blank" rel="noopener"><span>Primární zdroj</span><strong>Monitor MF ČR ↗</strong></a></div></section>
</main>{footer('../../')}<script src="../../municipal-i18n.js?v=20260822-history-explorer" defer></script><script src="../../cz-municipal-directory.js?v=20260822-history-explorer" defer></script></body></html>\n""", encoding="utf-8")
...
def build_detail(data: dict, entity: dict, has_large_city_history: bool) -> None:
    ...
    history_script = '<script src="../../../cz-history.js" defer></script>'
