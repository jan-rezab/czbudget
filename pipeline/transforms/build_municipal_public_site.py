...
def assign_slugs(municipalities: list[dict], large_ids: set[str]) -> None:
    ...
    for entity in ordered:
        ...
        used.add(slug)
        entity["seo"] = {"slug": slug, "path": f"/cz/municipalities/{slug}/"}
...
def build_directory(data: dict) -> None:
    ...
    schema = {
        "@context": "https://schema.org", "@type": "Dataset", "name": "Czech town and municipality budgets 2010–2025",
        "description": "Historical revenue, expenditure, fiscal balances, cash and population for 6,254 Czech towns and municipalities, with per-person spending benchmarks.",
        "url": PUBLIC_ORIGIN + "/cz/municipalities/", "inLanguage": "en", "temporalCoverage": "2010/2025", "spatialCoverage": "CZ",
    ...
    page_head = head('Czech town and municipality budgets 2010–2025 — revenue, expenditure and cash', 'Search and compare revenue, expenditure, fiscal balances, cash and per-person spending for every Czech town and municipality from 2010 to 2025.', '/cz/municipalities/', 2, schema, language="en").replace('cz-budget.css"', 'cz-budget.css?v=20260824-history-views2"')
    ...
    output = WEB / "cz/municipalities/index.html"
    output.parent.mkdir(parents=True, exist_ok=True)
    output.write_text(f"""<!doctype html><html lang="en">{page_head}
...
<section class="cz-hero compact-cz-hero"><div><span class="eyebrow"><i class="live-dot"></i>České územní rozpočty · skutečnost 2025</span><h1>Obce a kraje<br><em>v jednom součtu</em></h1><p>Všechny obecní účetní jednotky, kraje i společný součet. Praha je započtena jen jednou.</p></div><div class="cohort-switch wide-switch"><a class="active" href="../municipalities/">Obce <b>6 254</b></a><a href="../mesta/">Velká města <b>20 let</b></a><a href="../kraje/">Kraje <b>14</b></a></div></section>
...
<section class="directory" id="subjekty"><div class="directory-title"><div><span class="kicker">05 / Všechny obce · <b id="municipality-directory-year">2025</b></span><h2>Najděte obec</h2></div><p>Jednotná data FIN 2-12 M, rozvahy a ČSÚ pro vybraný rok. Stav účtů nezahrnuje samostatné příspěvkové organizace.</p></div>
...
</main>{footer('../../')}<script src="../../municipal-i18n.js?v=20260823-english-route" defer></script><script src="../../cz-municipal-directory.js?v=20260823-english-route" defer></script></body></html>\n""", encoding="utf-8")
...
def build_detail(data: dict, entity: dict, has_large_city_history: bool) -> None:
    ...
    history_script = '<script src="../../../cz-history.js?v=20260824-history-views" defer></script>'
...
def build_sitemap(data: dict, benchmark: dict) -> None:
    paths = [
        ...
        "/cz/municipalities/", "/cz/mesta/", "/cz/kraje/",
...
def main() -> None:
    ...
    parser.add_argument("--profiles-only", action="store_true", help="Regenerate all Czech profile shells without rewriting data, directories, or sitemap")
    ...
    if args.profiles_only:
        ...
        print(json.dumps({"municipal_profiles": len(data["municipalities"]), "mode": "profiles-only"}, ensure_ascii=False))
        return
