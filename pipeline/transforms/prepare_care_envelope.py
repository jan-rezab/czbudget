...
BENCH = ROOT / "website" / "data" / "municipal-benchmarks"
OUT = pathlib.Path(os.environ.get("CARE_ENVELOPE_OUT", ROOT / "outputs" / "20260827-care-envelope"))

# See prepare_hospital_ownership.py: the stamp reports the real generation date
# unless CZBUDGET_GENERATED_AT pins it.
...
def main() -> None:
    ...
    cz = json.loads((ROOT / "website" / "data" / "cz-health-budget.v1.json")
