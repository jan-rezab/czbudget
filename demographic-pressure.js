(() => {
  ...
  const copy = {
    cs: {
      ...
      countryKicker:"Plodnost, migrace a budoucí účet", countryTitle:"Co mění poměr plátců a příjemců.",
    ...
    en: {
      ...
      countryKicker:"Fertility, migration and the future bill", countryTitle:"What changes the ratio of contributors to recipients.",
