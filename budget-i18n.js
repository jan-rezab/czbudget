(() => {
  const csToEn = {
    ...
    "{n} / Detailní struktura":"{n} / Detailed structure","Co rozpočet živí.":"What funds the budget.","A co živí rozpočet.":"And what the budget funds.","Příjmová část":"Revenue structure","Výdajová část":"Expenditure structure","podíl v %":"share in %",
