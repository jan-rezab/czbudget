(() => {
  ...
  Object.assign(copy.cs,{industrialDiagnostics:"Uvnitř průmyslu",industrialDiagnosticsCopy:"Firemní přebytek a investice, kapacity, výroba a konkrétní výrobky. 120 datových sad Eurostatu s historií od roku 2010.",industry:"Průmysl měsíc po měsíci",industryCopy:"Která odvětví rostou a která klesají. Měsíce, roční souhrny a dohledatelné národní i evropské zdroje."});
  Object.assign(copy.en,{industrialDiagnostics:"Inside industry",industrialDiagnosticsCopy:"Business earnings and investment, factory capacity, real output and individual products. 120 Eurostat datasets with available history since 2010.",industry:"Industry month by month",industryCopy:"Which sectors grow and which contract. Monthly trends, annual summaries, and traceable national and European sources."});
