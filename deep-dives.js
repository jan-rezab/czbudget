(() => {
  ...
  Object.assign(copy.cs,{capitalCities:"Hlavní města",capitalCitiesCopy:"Oficiální rozpočtové plány oddělené od skutečnosti, datovaný turistický tlak a pět srovnatelných skupin."});
  Object.assign(copy.en,{capitalCities:"Capital cities",capitalCitiesCopy:"Official budget plans separated from actuals, dated visitor pressure and five comparable city clusters."});
