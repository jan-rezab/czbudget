...
<html lang="${lang}">
  <head>
    ...
    <link rel="stylesheet" href="/municipal-expanded-profile.css?v=20260912-history-chart" />
    <link rel="stylesheet" href="/global-footer.css" />
    <script src="/global-nav.js?v=20260827-country-methodology" defer></script>
    <script src="/municipal-expanded-profile.js?v=20260912-history-chart" defer></script>
