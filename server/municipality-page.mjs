...
export function municipalityPage({ route, release_id }) {
  ...
  const historyEndpoint = `/public-data/municipality-history?path=${encodeURIComponent(route.path)}`;
...
<html lang="en">
  <head>
    ...
    <script src="/municipal-expanded-profile.js?v=20260828-snapshot-serving" defer></script>
    <script src="/global-footer.js?v=20260825-footer-align" defer></script>
  </head>
  <body class="municipalities-page benchmark-profile expanded-profile cz-budget-page detail-page international-municipality-profile" data-profile-url="${profileEndpoint}" data-history-url="${historyEndpoint}" data-snapshot-release="${escapeHTML(release_id)}">
