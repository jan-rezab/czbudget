...
export const openapi = {
  ...
  paths: {
    ...
    "/api/v1/trade/explorer": { get: operation("Explore annual trade history", "Loaded annual goods imports and exports from 1997, for one to four comma-separated ISO-3 countries. Current USD; missing values remain absent.", ["Trade"]) },
