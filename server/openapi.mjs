...
export const openapi = {
  ...
  paths: {
    ...
    "/api/v1/capital-cities/{city_id}": { get: operation("Get capital-city budget", "Returns the complete source-scoped capital-city budget record.", ["Cities"], [{ name: "city_id", in: "path", required: true, schema: { type: "string", example: "prague-cze" } }]) },
