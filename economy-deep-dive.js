(() => {
  ...
  const copy = {
    cs:{eyebrow:"Hloubkový profil / Ekonomika",titleLead:"Rozpočet nikdy",titleEm:"nežije sám.",intro:"Dlouhé roční řady pro strukturu, čtvrtletí pro cyklus a měsíce pro body obratu. Každý údaj zůstává spojen se zdrojem, jednotkou a transformací.",globalPanel:"Globální datová vrstva",countries:"zemí a ekonomik",definitions:"definic",enoughNav:"Kolik historie stačí?",cycleNav:"Hospodářský cyklus",explorerNav:"Průzkumník řad",coverageNav:"Pokrytí",methodNav:"Datová struktura",enoughKicker:"01 / Hloubka vzorku",enoughTitle:"Dvacet let je začátek, ne cíl.",enoughIntro:"Dvacet ročních bodů popíše jednu generaci veřejných financí, ale obvykle jen dva až tři velké šoky. Pro strukturální vztahy potřebujeme více režimů.",sample20Title:"Popisný základ",sample20Copy:"Vhodné pro trend a účetní srovnání. Slabé pro stabilní regresní závěry.",sample30Title:"Praktické minimum",sample30Copy:"Tři dekády obvykle zachytí více cyklů a změn politiky.",sample60Title:"Strukturální analýza",sample60Copy:"Lepší pro režimy, zpoždění a kontroly robustnosti—pokud jsou definice srovnatelné.",sampleQTitle:"Cyklická analýza",sampleQCopy:"Stejných dvacet let znamená přibližně 80 čtvrtletí nebo 240 měsíců.",ruleLabel:"Pravidlo pro reporty",ruleCopy:"Používat 1995–2025 pro roční srovnání, 2000–2025 pro čtvrtletní cyklus a nejdelší konzistentní řadu pro strukturální testy. Délka sama neopraví změny metodiky ani endogenitu.",cycleKicker:"02 / Pět čoček",cycleTitle:"Od výkonu ekonomiky k rozpočtu.",cycleIntro:"Růst, inflace a nezaměstnanost popisují cyklus. Saldo a dluh ukazují fiskální stopu—nikoli automaticky kauzalitu.",countryLabel:"Země",explorerKicker:"03 / Zdrojová řada",explorerTitle:"Stejný pojem může mít více správných měření.",explorerIntro:"Filtr zachovává frekvenci, transformaci a sezónní očištění. Právě tyto rozdíly musí budoucí report uvádět.",indicatorLabel:"Ukazatel",seriesLabel:"Varianta řady",coverageKicker:"04 / Co opravdu máme",coverageTitle:"Pokrytí je vlastnost dat, ne poznámka pod čarou.",coverageIntro:"Tabulka počítá skutečné body a první/poslední období pro vybranou zemi. Nula znamená chybějící řadu, nikoli ekonomickou hodnotu nula.",topicLabel:"Oblast",availableLabel:"Dostupné řady",historyLabel:"Nejdelší historie",pointsLabel:"Pozorování",methodKicker:"05 / Kontrakt pro další reporty",methodTitle:"Jedna faktová tabulka. Žádné skryté přepočty.",methodIntro:"Každý bod nese zemi, ukazatel, plný klíč zdrojové řady, frekvenci, období, jednotku, sezónní očištění, transformaci, vintage a URL zdroje.",rawTitle:"Raw snapshot",rawCopy:"Datované soubory OECD, BIS, World Bank a IMF s kontrolním součtem.",factTitle:"Observation fact",factCopy:"1,4+ milionu řádků v jednotném dlouhém formátu bez imputace.",reportTitle:"Report marts",reportCopy:"Kompaktní výřezy pro grafy, coverage a nejnovější hodnoty.",causalLabel:"Důležitá hranice",causalCopy:"Více pozorování zvyšuje přesnost popisu, ale nevytváří kauzální identifikaci. Závěry o dopadu politiky vyžadují samostatný design: přirozený experiment, instrument, difference-in-differences nebo jinou obhajitelnou strategii.",footer:"Economy deep dive · IMF, OECD, World Bank and BIS",noData:"Řada není pro tuto zemi dostupná",latest:"Nejnovější",seriesCount:"řad",observationCount:"bodů",annualSpan:"let roční historie",monthly:"měsíčně",quarterly:"čtvrtletně",annual:"ročně"},
    en:{eyebrow:"Deep dive / Economy",titleLead:"A budget never",titleEm:"lives alone.",intro:"Long annual histories for structure, quarters for the cycle and months for turning points. Every observation remains tied to its source, unit and transformation.",globalPanel:"Global data layer",countries:"countries and economies",definitions:"definitions",enoughNav:"How much history?",cycleNav:"Economic cycle",explorerNav:"Series explorer",coverageNav:"Coverage",methodNav:"Data structure",enoughKicker:"01 / Sample depth",enoughTitle:"Twenty years is a start, not the goal.",enoughIntro:"Twenty annual points describe one generation of public finance, but usually only two or three large shocks. Structural relationships need more regimes.",sample20Title:"Descriptive base",sample20Copy:"Useful for trends and accounting comparisons. Weak for stable regression conclusions.",sample30Title:"Practical minimum",sample30Copy:"Three decades usually capture more cycles and policy changes.",sample60Title:"Structural analysis",sample60Copy:"Better for regimes, lags and robustness checks—if definitions remain comparable.",sampleQTitle:"Cycle analysis",sampleQCopy:"The same twenty years yield roughly 80 quarters or 240 months.",ruleLabel:"Reporting rule",ruleCopy:"Use 1995–2025 for annual comparisons, 2000–2025 for the quarterly cycle and the longest consistent series for structural tests. Length alone does not repair methodology breaks or endogeneity.",cycleKicker:"02 / Five lenses",cycleTitle:"From economic performance to the budget.",cycleIntro:"Growth, inflation and unemployment describe the cycle. Balance and debt show the fiscal footprint—not automatic causality.",countryLabel:"Country",explorerKicker:"03 / Source series",explorerTitle:"One concept can have several valid measurements.",explorerIntro:"The filter preserves frequency, transformation and seasonal adjustment. Future reports must disclose these distinctions.",indicatorLabel:"Indicator",seriesLabel:"Series variant",coverageKicker:"04 / What we really have",coverageTitle:"Coverage is a data property, not a footnote.",coverageIntro:"The table counts actual points and first/last periods for the selected country. Zero means missing—not an economic value of zero.",topicLabel:"Topic",availableLabel:"Available series",historyLabel:"Longest history",pointsLabel:"Observations",methodKicker:"05 / Contract for future reports",methodTitle:"One fact table. No hidden conversions.",methodIntro:"Every point carries country, indicator, full source-series key, frequency, period, unit, seasonal adjustment, transformation, vintage and source URL.",rawTitle:"Raw snapshot",rawCopy:"Dated OECD, BIS, World Bank and IMF files with checksums.",factTitle:"Observation fact",factCopy:"1.4+ million rows in one long format, without imputation.",reportTitle:"Report marts",reportCopy:"Compact extracts for charts, coverage and latest values.",causalLabel:"Important boundary",causalCopy:"More observations improve description but do not create causal identification. Policy-impact claims require a separate design: natural experiment, instrument, difference-in-differences or another defensible strategy.",footer:"Economy deep dive · IMF, OECD, World Bank and BIS",noData:"This series is unavailable for the selected country",latest:"Latest",seriesCount:"series",observationCount:"points",annualSpan:"years of annual history",monthly:"monthly",quarterly:"quarterly",annual:"annual"}
  }[lang];
