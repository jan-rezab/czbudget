(() => {
  ...
  Object.assign(C.cs,{navAbout:"O projektu",aboutKicker:"05 / O projektu",aboutTitle:"Veřejné rozpočty, kterým lze rozumět.",aboutCopy:"Public Spending Data zpřístupňuje oficiální údaje o rozpočtech obcí a evropských měst na jednom místě. Zachovává původní zdroje, roky, měny i účetní rozsah, aby bylo jasné, co lze srovnávat a kde má srovnání hranice.",aboutNote:"Projekt staví na otevřených datech veřejných institucí. Není oficiálním portálem žádné vlády ani samosprávy.",creditsKicker:"Projekt připravuje",creditsCopy:"Nezávislá česká nezisková watchdog organizace, která propojuje a analyzuje veřejná data a pomáhá kontrolovat hospodaření státu.",legalForm:"Právní forma",legalFormValue:"zapsaný ústav · nezisková organizace",registeredOffice:"Sídlo",officialSite:"Oficiální web ↗",aboutHlidac:"O Hlídači státu ↗",impactReport:"Výsledky a dopad ↗"});
  Object.assign(C.en,{navAbout:"About",aboutKicker:"05 / About the project",aboutTitle:"Public budgets made understandable.",aboutCopy:"Public Spending Data brings official budget data for municipalities and European cities together in one place. It preserves original sources, years, currencies and accounting scope, making clear what can be compared and where comparisons have limits.",aboutNote:"The project is built on open data from public institutions. It is not an official portal of any government or municipality.",creditsKicker:"Created by",creditsCopy:"An independent Czech nonprofit watchdog that connects and analyses public data and helps scrutinise how the state manages public money.",legalForm:"Legal form",legalFormValue:"registered institute · nonprofit organisation",registeredOffice:"Registered office",officialSite:"Official website ↗",aboutHlidac:"About Hlídač státu ↗",impactReport:"Results and impact ↗"});
