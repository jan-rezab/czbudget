(() => {
  ...
  const copy = {
    cs:{eyebrow:"Hloubkový profil / Obrana",titleLead:"Kolik stojí",titleEm:"obrana?",intro:"Stejná osa pro mezinárodní srovnání. Původní rozpočtové řádky pro detail každé země.",countryLabel:"Země",countryProfile:"Otevřít celý profil země",compareNav:"% HDP",detailNav:"Detail země",linesNav:"Rozpočtové řádky",methodNav:"Metodika",compareKicker:"01 / První pohled",compareTitle:"Výdaje na armádu vůči velikosti ekonomiky.",compareIntro:"Nejnovější srovnatelný rok SIPRI. U členů NATO vyznačujeme závazek pro jádrové obranné výdaje do roku 2035.",latestComparable:"nejnovější společný rok",natoTarget:"jádrový cíl NATO do 2035",natoTotal:"celkem včetně širší bezpečnosti",detailKicker:"02 / Detail země",detailTitle:"v čase a v rozpočtu.",trendKicker:"Historie",trendTitle:"Vojenské výdaje jako % HDP",trendNote:"Změna v čase používá jednu harmonizovanou řadu. Mezery nejsou nuly.",linesKicker:"03 / Původní rozpočet",linesTitle:"Od celku k poslednímu dostupnému řádku.",searchLabel:"Hledat v rozpočtu",shownLabel:"Zobrazeno",codeHeader:"Kód",parentHeader:"Program / kapitola",lineHeader:"Rozpočtový řádek",classHeader:"Klasifikace",amountHeader:"Částka",methodKicker:"04 / Co lze srovnávat",methodTitle:"Jedno měřítko nahoře. Národní pravda dole.",methodIntro:"Mezinárodní graf je harmonizovaný. Detailní tabulky zachovávají národní rozsah, rok, měnu i klasifikaci a proto se mezi zeměmi nesčítají řádek po řádku.",methodCompare:"Roční vojenské výdaje jako podíl HDP, licence CC BY 4.0.",methodNato:"Hagský závazek: 3,5 % HDP na jádrové obranné potřeby a až 1,5 % na širší bezpečnost do roku 2035.",nationalTitle:"Národní rozpočty",methodNational:"Nejjemnější legálně a veřejně dostupná strojově čitelná vrstva, kterou máme pro danou zemi staženou.",natoMembers:"Členové NATO",otherCountries:"Partneři a ostatní země",targetLabel:"NATO 3,5 %",chartNote:"SIPRI a NATO používají odlišné definice; čára je kontext, nikoli verdikt o plnění.",axisCapped:"Osa je kvůli čitelnosti zastropována na 6 %; hodnota Ukrajiny je vypsána celá.",gdpShare:"vojenské výdaje / HDP",budgetTotal:"součet zobrazených řádků",budgetLines:"rozpočtových řádků",budgetPeriod:"období rozpočtu",noLines:"Žádný řádek neodpovídá hledání.",loadError:"Data obranného profilu se nepodařilo načíst.",nato:"NATO",notNato:"mimo NATO"},
    en:{eyebrow:"Deep dive / Defense",titleLead:"What does",titleEm:"defense cost?",intro:"One scale for international comparison. Original budget lines for each country’s detail.",countryLabel:"Country",countryProfile:"Open full country profile",compareNav:"% of GDP",detailNav:"Country detail",linesNav:"Budget lines",methodNav:"Method",compareKicker:"01 / First view",compareTitle:"Military spending relative to the economy.",compareIntro:"The latest common SIPRI year. NATO members carry the core-defense commitment for 2035.",latestComparable:"latest common year",natoTarget:"NATO core target by 2035",natoTotal:"total incl. broader security",detailKicker:"02 / Country detail",detailTitle:"over time and in the budget.",trendKicker:"History",trendTitle:"Military expenditure as % of GDP",trendNote:"The time series uses one harmonised measure. Gaps are not zeroes.",linesKicker:"03 / Native budget",linesTitle:"From the total to the last available line.",searchLabel:"Search the budget",shownLabel:"Showing",codeHeader:"Code",parentHeader:"Programme / chapter",lineHeader:"Budget line",classHeader:"Classification",amountHeader:"Amount",methodKicker:"04 / What is comparable",methodTitle:"One measure above. National truth below.",methodIntro:"The international chart is harmonised. Detail tables preserve national scope, year, currency and classification, so their rows should not be compared line by line across countries.",methodCompare:"Annual military expenditure as a share of GDP, licensed CC BY 4.0.",methodNato:"The Hague commitment: 3.5% of GDP for core defense and up to 1.5% for broader security by 2035.",nationalTitle:"National budgets",methodNational:"The finest legal, public and machine-readable layer currently downloaded for each country.",natoMembers:"NATO members",otherCountries:"Partners and other countries",targetLabel:"NATO 3.5%",chartNote:"SIPRI and NATO use different definitions; the marker is context, not a compliance ruling.",axisCapped:"The axis is capped at 6% for readability; Ukraine’s full value is printed.",gdpShare:"military expenditure / GDP",budgetTotal:"sum of displayed lines",budgetLines:"budget lines",budgetPeriod:"budget period",noLines:"No budget line matches the search.",loadError:"Defense profile data could not be loaded.",nato:"NATO",notNato:"non-NATO"}
  }[lang];
