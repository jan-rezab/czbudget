...
function render(){translate();header();snapshot();charts();specifics();sources();dispatchEvent(new CustomEvent("countryprofilechange",{detail:{code:state.code,lang:state.lang,year:state.year,currency:state.currency}}))}
function init(){
