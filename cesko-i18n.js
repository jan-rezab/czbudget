(() => {
  ...
  const csToEn = {
    ...
    "Otevřít žebříčky":"Open the rankings", "38 strategických subjektů · skutečnost 2024":"38 strategic entities · 2024 actuals",
    ...
    "Sledované subjekty":"Tracked entities", "strategické firmy a organizace":"strategic companies and organisations", "mld. Kč · součet 2024":"CZK bn · 2024 total", "mld. Kč · dividendy a odvody":"CZK bn · dividends and payments", "Zaměstnanci":"Employees", "osob na konci roku":"people at year-end",
    "01 / Výsledek hospodaření":"01 / Financial result", "Dva konce":"Two ends", "jednoho portfolia.":"of one portfolio.",
    "TOP 20 používá individuální údaje 38 strategických subjektů za rok 2024. Úplný registr firem, veřejných vysokých škol a nemocnic je pod zvýrazněnými žebříčky.":"The top 20 uses individual 2024 figures for 38 strategic entities. The complete register of companies, public universities and hospitals appears below the highlighted rankings.",
    "Suma zisků":"Sum of profits", "Suma ztrát":"Sum of losses", "Výnosy / obrat":"Revenue / turnover", "mld. Kč · dostupné výkazy":"CZK bn · available statements", "Součty za všechny subjekty s dostupným výsledkem za rok 2024.":"Totals for all entities with an available 2024 result.",
    "20 nejziskovějších":"20 most profitable", "20 nejslabších":"20 weakest", "20 největších":"20 largest", "Nejziskovější strategické subjekty":"Most profitable strategic entities", "Jak číst pořadí":"How to read the ranking",
  ...
  function translateTree(root) {
    ...
    while (walker.nextNode()) {
      ...
      if (csToEn[trimmed]) walker.currentNode.nodeValue = text.replace(trimmed, csToEn[trimmed]);
    }
    root.querySelectorAll?.("[aria-label]").forEach((node) => {
      const value = node.getAttribute("aria-label");
      if (csToEn[value]) node.setAttribute("aria-label", csToEn[value]);
    });
