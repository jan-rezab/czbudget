...
const I = {
  cs: {
    ...
    atlasKicker: "Městský atlas", atlasTitle: "Čtyři ukazatele vedle sebe", atlasCopy: "Rozpočet, obyvatelé, turistická přenocování a intenzita cestovního ruchu. Kliknutím na řádek otevřete přesný rozsah a původ hodnoty.",
  ...
  en: {
    ...
    atlasKicker: "City atlas", atlasTitle: "Four measures side by side", atlasCopy: "Budget, population, tourist nights and tourism intensity. Select a row to see the exact scope and source behind the value.",
...
Object.assign(I.cs,{
  ...
  warningLabel:"Plán není skutečnost.",warningCopy:"Všechny fiskální částky v meziměstském atlasu jsou oficiální rozpočtové plány, nikoli skutečné plnění. Městské struktury a účetní definice se navíc liší.",atlasTitle:"Rozpočtové plány vedle populace a turistiky",atlasCopy:"Tabulka porovnává rozpočtové plány. Populace a turistika mají vlastní referenční roky; skutečné fiskální výsledky se zobrazují samostatně.",
...
Object.assign(I.en,{
  ...
  warningLabel:"Plan is not actual.",warningCopy:"Every cross-city fiscal amount in this atlas is an official budget plan, not actual execution. Municipal structures and accounting definitions also differ.",atlasTitle:"Budget plans beside population and tourism",atlasCopy:"The table compares budget plans. Population and tourism retain their own reference years; actual fiscal outcomes appear in a separate layer.",
