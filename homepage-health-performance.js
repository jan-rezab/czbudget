(() => {
  ...
  const flags = {CZE:"cz",DEU:"de",DNK:"dk",FRA:"fr",GBR:"gb",POL:"pl",SWE:"se",CHE:"ch",USA:"us",UKR:"ua",GRC:"gr"};
  const copy = {
    cs:{kicker:"Výkon zdravotních systémů",title:"Výdaje na zdraví, kapacita a výsledky.",intro:"Patnáct ukazatelů propojuje výdaje, personál, kapacitu, využití nemocnic a zdravotní výsledky. Srovnání zobrazuje poslední dostupnou hodnotu pro deset profilů s dostatečným pokrytím.",groups:{spending:"Výdaje",workforce:"Personál",capacity:"Kapacita",utilisation:"Využití",outcomes:"Výsledky"},metric:"Ukazatel",anchor:"Srovnávaná země",sort:"Řazení",highLow:"Od nejvyšší hodnoty",selected:"Vybraná země",median:"Medián zemí",coverage:"Pokrytí",countries:"zemí",profile:"Detail země",matrix:"Všech patnáct ukazatelů",matrixCopy:"Každá buňka zachovává vlastní poslední dostupný rok. Kliknutím na ukazatel změníte hlavní srovnání.",method:"Jak srovnání číst",methodCopy:"Hodnoty řadíme od nejvyšší po nejnižší. Pořadí není celkové skóre: u úmrtnosti nebo délky pobytu může být nižší hodnota příznivější. Různé referenční roky nedopočítáváme ani nenahrazujeme nulou.",latest:"poslední dostupný rok",noData:"Bez dat",loading:"Načítám zdravotní ukazatele…",source:"Zdroje"},
    en:{kicker:"Health-system performance",title:"Health spending, capacity and outcomes.",intro:"Fifteen indicators cover spending, workforce, capacity, hospital use and outcomes. The comparison uses the latest available value for the ten profiles with sufficient coverage.",groups:{spending:"Spending",workforce:"Workforce",capacity:"Capacity",utilisation:"Utilisation",outcomes:"Outcomes"},metric:"Metric",anchor:"Compared country",sort:"Sort",highLow:"Highest value first",selected:"Selected country",median:"Country median",coverage:"Coverage",countries:"countries",profile:"Country profile",matrix:"All fifteen indicators",matrixCopy:"Every cell retains its own latest available year. Select an indicator to update the main comparison.",method:"How to read the comparison",methodCopy:"Values are sorted from highest to lowest. The order is not an overall score: for mortality or length of stay, a lower value may be preferable. Different reference years are neither imputed nor treated as zero.",latest:"latest available year",noData:"No data",loading:"Loading health indicators…",source:"Sources"}
  };
