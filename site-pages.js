(() => {
  ...
  const copy = {
    cs: {
      ...
      atlasEyebrow:"Data · celý svět",atlasTitle:"POKRYTÍ",atlasLead:"Mapa a řaditelná tabulka zahrnují všech 195 suverénních států. Makrofiskální profily jsou načtené pro všech 191 států dostupných ve WEO; Kuba, Monako, Severní Korea a Vatikán v tomto zdroji chybějí.",
    ...
    en: {
      ...
      atlasEyebrow:"Data · whole world",atlasTitle:"COVERAGE",atlasLead:"The map and sortable table include all 195 sovereign states. Macro-fiscal profiles are loaded for all 191 states available in WEO; Cuba, Monaco, North Korea and Vatican City are absent from that source.",
