(() => {
  ...
  const copy = {
    cs: {
      ...
      atlasEyebrow:"Data · celý svět",atlasTitle:"POKRYTÍ",atlasLead:"Mapa a řaditelná tabulka zahrnují všech 195 suverénních států. Index rozpočtové transparentnosti kombinuje centrální skóre OBS s bonusem za hloubku obecních dat a ukazuje, které zelené země ještě musíme načíst.",
    ...
    en: {
      ...
      atlasEyebrow:"Data · whole world",atlasTitle:"COVERAGE",atlasLead:"The map and sortable table include all 195 sovereign states. The Budget Transparency Index combines the central OBS score with a municipal-depth bonus and identifies green countries that PSD still needs to load.",
