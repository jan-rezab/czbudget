(() => {
  ...
  const copy = {
    cs: {
      ...
      atlasEyebrow:"Data · celý svět",atlasTitle:"POKRYTÍ",atlasLead:"Mapa a tabulka zahrnují všech 195 suverénních států. Výchozí skóre PSD kombinuje transparentnost centrálního rozpočtu s bonusem za hloubku obecních dat. Tmavě šedá znamená neprověřeno nebo bez ověřeného skóre.",
    ...
    en: {
      ...
      atlasEyebrow:"Data · whole world",atlasTitle:"COVERAGE",atlasLead:"The map and table include all 195 sovereign states. The default PSD score combines central-budget transparency with a bonus for municipal data depth. Dark gray means not researched or no verified score component.",
