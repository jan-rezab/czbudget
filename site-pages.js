(() => {
  ...
  const copy = {
    cs: {
      ...
      atlasEyebrow:"Rozpočtová transparentnost · svět",atlasTitle:"Co vlády zveřejňují — stát i obce, bez zaměňování vrstev.",atlasLead:"Mapa pokrývá 195 států. Výchozí skóre PSD kombinuje transparentnost centrálního rozpočtu s bonusem za hloubku obecních dat. Tmavě šedá znamená neprověřeno nebo bez ověřeného skóre.",
    ...
    en: {
      ...
      atlasEyebrow:"Budget transparency · world",atlasTitle:"What governments publish — national and municipal, kept distinct.",atlasLead:"The map covers 195 states. Its default PSD score combines central-budget transparency with a bonus for municipal data depth. Dark gray means not researched or no verified score component.",
