(() => {
  ...
  const statusLabel=status=>copy[current][({full:"ledgerFull",partial:"ledgerPartial",aggregate:"ledgerAggregate",unavailable:"ledgerUnavailable"})[status]||"ledgerUnavailable"];
  ...
  function renderMethodology(){
    ...
    fillSelect("#method-status-filter",[{value:"full",cs:"Plné",en:"Full"},{value:"partial",cs:"Částečné",en:"Partial"},{value:"aggregate",cs:"Agregát",en:"Aggregate"},{value:"unavailable",cs:"Nedostupné",en:"Unavailable"}],copy[current].ledgerAllStatuses,current);
