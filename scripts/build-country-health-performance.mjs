...
const COUNTRIES = ["CZE","DEU","DNK","FIN","FRA","GBR","POL","SWE","CHE","USA","UKR","BRA","ESP","JPN","NLD","NOR","GRC"];
...
const payload={
  ...
  coverage:"Seventeen-country performance layer. World Bank indicators provide the common spine; OECD hospital utilisation and avoidable mortality have partial country coverage.",
  methodology:{
