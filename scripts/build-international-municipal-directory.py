...
def main():
    ...
    payload = {"schema_version":"1.0.0","generated_at":"2026-08-22","scope":"municipality_comparison_tier","countries":[{"code":code,**data,"directory_count":sum(1 for row in entities if row["country"]==code)} for code,data in COUNTRIES.items()],"entities":entities,"notes":{"comparability_cs":"Částky zůstávají v národní měně a národní klasifikaci. Rozpočtovou fázi a účetní rozsah vždy porovnávejte společně.","comparability_en":"Amounts remain in national currency and national classifications. Always compare budget stage and accounting scope together."}}
