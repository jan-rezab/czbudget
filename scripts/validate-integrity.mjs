...
if (!dataOnly) {
  ...
  const expectedSitemapUrls = municipalities.length + 1 + municipalityCountryPaths.length + 15 + 6 + 6 + benchmarkMunicipalities.length + 4 + countryPaths.length + expansionProfiles.length + 7 + municipalSpecialPages + productMarketPages + accountabilityPages + industryPages + czechSourcePages + cityvizorPages;
