...
if (!dataOnly) {
  ...
  const pragueProjectPages = existsSync(path.join(root, "cz/kraje/praha/projekty/index.html")) ? 1 : 0;
  ...
  const expectedSitemapUrls = municipalities.length + 1 + municipalityCountryPaths.length + 15 + 6 + 6 + benchmarkMunicipalities.length + 4 + countryPaths.length + expansionProfiles.length + 7 + municipalSpecialPages + productMarketPages + accountabilityPages + pragueProjectPages + industryPages + czechSourcePages + cityvizorPages;
