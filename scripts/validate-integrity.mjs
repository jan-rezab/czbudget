...
if (!dataOnly) {
  ...
  const expectedSitemapUrls = municipalities.length + 14 + 9 + 6 + 2;
  ...
  for (const publicPath of ["/", "/cesko.html", "/cesky-rozpocet.html", "/eu-capitals.html", "/municipalities/", ...municipalityCountryPaths, "/deep-dives/", "/deep-dives/transportation/", "/cz/obce/", "/cz/mesta/", "/cz/kraje/"]) {
