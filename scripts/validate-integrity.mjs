...
if (!dataOnly) {
  ...
  const expectedSitemapUrls = municipalities.length + 14 + 9 + 6 + 4 + benchmarkMunicipalities.length + 3;
  ...
  for (const publicPath of ["/", "/cesko.html", "/cesky-rozpocet.html", "/eu-capitals.html", "/municipalities/", ...municipalityCountryPaths, "/deep-dives/", "/deep-dives/transportation/", "/deep-dives/health/", "/deep-dives/state-owned-enterprises/", "/cz/municipalities/", "/cz/mesta/", "/cz/kraje/"]) {
