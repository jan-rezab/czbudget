...
if (!dataOnly) {
  ...
  const industryPages = existsSync(path.join(root, "deep-dives/industry/index.html")) ? 1 : 0;
  ...
  for (const publicPath of ["/", "/cesko.html", "/cesky-rozpocet.html", "/eu-capitals.html", ...countryPaths, "/municipalities/", ...municipalityCountryPaths, "/deep-dives/", "/deep-dives/eu-budget/", "/deep-dives/education/", "/deep-dives/transportation/", "/deep-dives/health/", "/deep-dives/state-owned-enterprises/", "/deep-dives/capital-cities/", "/deep-dives/revenue/", "/deep-dives/ageing/", "/deep-dives/migration/", "/deep-dives/defense/", "/deep-dives/tax-burden/", "/deep-dives/redistribution/", "/deep-dives/trade/", "/deep-dives/product-markets/", "/deep-dives/industry/", "/deep-dives/budget-planner/", "/deep-dives/plzen-contracts/", "/deep-dives/digital-spillover/", "/deep-dives/public-employment/", "/cz/municipalities/", "/cz/mesta/", "/cz/kraje/", "/cz/kraje/accountability/"]) {
