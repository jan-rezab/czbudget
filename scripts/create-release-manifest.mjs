...
const selected = [
  ...
  "data/international-municipalities.v1.json", "data/international-itemized-warehouse.v1.json", "data/municipal-itemized-coverage.v1.json", "data/municipal-transparency.v1.json", "data/world-map.v1.json",
