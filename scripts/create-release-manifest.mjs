...
const selected = [
  "data/benchmark.v1.json", "data/catalog.v1.json", "data/country-health.v1.json", "data/country-provider-networks.v1.json", "data/country-functional-budgets.v1.json", "data/country-cash-in.v1.json",
