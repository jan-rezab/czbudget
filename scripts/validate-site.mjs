...
if (!homepage.includes('styles-v2.css?v=20260822-brand') || !homepage.includes('homepage-v2.js?v=20260822-separate-pages') || !homepage.includes('global-nav.js?v=20260824-identity-outlines') || !homepage.includes('site-header.css?v=20260824-header-lockup')) throw new Error("Homepage assets must be cache-busted for the shared-header release");
...
for (const path of await htmlFiles()) {
  ...
  if ((page.match(/global-nav\.js\?v=(?:20260822-component|20260824-identity-outlines)/g) || []).length !== 1) throw new Error(`${path}: expected exactly one shared header script`);
