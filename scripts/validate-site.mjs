...
const countryPublicEntities = JSON.parse(await readFile("data/country-public-entities.v1.json", "utf8"));
...
if (Object.keys(countryPublicEntities.countries).length !== 10) throw new Error("Expected public-entity portfolios for all ten countries");
if (methodologySources.row_count !== 110 || methodologySources.countries.length !== 10 || methodologySources.modules.length !== 11) throw new Error("Expected the complete 10-country by 11-module methodology ledger");
...
if (!methodologyPage.includes('class="method-grid-expanded"') || !methodologyPage.includes('class="method-ledger"') || !aboutPage.includes("Hlidac statu, z.u.") || !homepage.includes("data-global-footer") || !internationalMunicipalPage.includes("data-global-footer")) throw new Error("Dedicated methodology, source ledger, About, and global project credits must be present");
if (!countryPage.includes('country-spending.js?v=20260823-dashboard-parity') || !countryPage.includes('country-insights.js?v=20260823-dashboard-parity') || !countryPage.includes('country-health.js?v=20260822-czech-flow') || !countryPage.includes('country-providers.js?v=20260822-network') || !countryPage.includes('country-functions.js?v=20260822-transport-deep-dive') || !countryPage.includes('country-cash-in.js?v=20260822-cash-in') || !countryPage.includes('country-parity.js?v=20260822-parity-contract') || !countryPage.includes('id="data-parity"') || !countryPage.includes('id="cash-in"') || !countryPage.includes('id="budget-map"') || !countryPage.includes('id="public-entities"') || !countryPage.includes('id="demography"') || !countryPage.includes('id="provider-network"') || !countryPage.includes('id="social-system"') || !countryPage.includes('id="transportation"') || !countryScript.includes('countryprofilechange') || !countryInsightsScript.includes("country-public-entities.v1.json")) throw new Error("Fiscal profiles must preserve all shared and parity insight modules");
...
for (const required of ["index.html", "comparison.html", "methodology.html", "about.html", "site-header.css", "site-pages.js", "site-pages.css", "global-footer.js", "global-footer.css", "homepage-category.js", "homepage-category.css", "deep-dives/index.html", "deep-dives/transportation/index.html", "deep-dives.js", "deep-dives.css", "data/country-parity.v1.json", "data/contracts/country-parity.schema.json", "data/country-spending-comparison.v1.json", "data/country-functional-budgets.v1.json", "data/country-demography.v1.json", "data/country-public-entities.v1.json", "data/methodology-sources.v1.json", "data/road-network-history.v1.json", "data/country-cash-in.v1.json", "data/country-provider-networks.v1.json", "data/international-municipalities.v1.json", "data/municipal-size-benchmark.v1.json", "municipalities.html", "municipalities/index.html", "municipalities/czechia/index.html", "municipalities.js", "municipalities-czechia.js", "municipalities.css", "municipalities-navigator.css", "eu-capitals.html", "eu-capitals.js", "eu-capitals.css", "country-parity.js", "country-parity.css", "country-insights.js", "country-insights.css", "country-spending.js", "country-health.js", "country-providers.js", "country-functions.js", "country-functions.css", "country-cash-in.js", "country-cash-in.css", "data/country-spending-2025-2026.v1.json", "data/country-health.v1.json", "cz/municipalities/index.html", "cz/mesta/index.html", "municipal-i18n.js", "scripts/build-country-parity.mjs", "scripts/build-country-demography.py", "scripts/build-methodology-sources.mjs", "scripts/build-country-functional-budgets.mjs", "pipeline/transforms/prepare_road_network_history.py", "scripts/build-country-cash-in.mjs", "scripts/build-country-provider-networks.mjs", "scripts/export-municipal-breakdowns.sql", "scripts/export-municipal-budget-codebook.sql", "scripts/merge-municipal-breakdowns.mjs", "sitemap.xml", ...["cz","de","dk","fr","gb","pl","se","ch","ua","us"].map((code)=>`assets/flags/${code}.svg`)]) await stat(required);
