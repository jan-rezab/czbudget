...
if (!homepage.includes('styles-v2.css?v=20260821-benchmark-flags') || !homepage.includes('homepage-v2.js?v=20260821-benchmark-flags') || !homepage.includes('global-nav.js?v=20260821-benchmark-flags')) throw new Error("Homepage assets must be cache-busted for the current benchmark release");
