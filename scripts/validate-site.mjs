...
if (globalBudgetTransparency.countries.filter((country) => country.budget_transparency_index?.score !== null).length !== 135 || globalBudgetTransparency.countries.filter((country) => country.psd_coverage?.country_profile === "loaded").length !== 16 || globalBudgetTransparency.countries.filter((country) => country.psd_coverage?.ingestion_status === "discovery_crawl_started").length !== 16) throw new Error("Budget Transparency Index must distinguish indexed, PSD-loaded and crawl-started countries");
