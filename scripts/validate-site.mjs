...
if (internationalMunicipalities.countries.length !== 13 || internationalMunicipalities.entities.length < 77000) throw new Error("Expected thirteen-country municipality directory with at least 77,000 entity rows");
if (municipalItemizedCoverage.countries.length !== 13 || municipalItemizedCoverage.countries.reduce((sum, country) => sum + country.profile_count, 0) !== 7264) throw new Error("Expected 7,264 itemized municipal profiles across thirteen countries");
...
if (!methodologyPage.includes('class="status-header"') || !methodologyPage.includes('id="coverage-matrix-body"') || !methodologyPage.includes('class="status-definitions"') || !methodologyPage.includes('class="method-ledger"') || !aboutPage.includes("Hlidac statu, z.u.") || !aboutPage.includes("hlidac-statu-horizontal-inverted-bw.svg") || aboutPage.includes("Mnichovice") || !homepage.includes("data-global-footer") || !internationalMunicipalPage.includes("data-global-footer")) throw new Error("Technical data status, source ledger, address-free About credit, and global project credits must be present");
