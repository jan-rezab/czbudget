...
if (!municipalTransparencyScript.includes('id="atlas-mode"') || !municipalTransparencyScript.includes('class="atlas-tooltip"') || !municipalTransparencyStyles.includes(".atlas-not_researched") || !municipalTransparencyStyles.includes("fill: #3f433f")) throw new Error("Global transparency atlas must expose layer controls, score explanations and dark-gray unresearched countries");
