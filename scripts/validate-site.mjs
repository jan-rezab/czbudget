...
if (!homepage.includes('id="category-comparison-root"') || !homepage.includes('homepage-category.js?v=20260828-home-top20') || !homepage.includes('homepage-category.css?v=20260828-home-top20')) throw new Error("Homepage must expose the compact country category comparison");
if (!homepage.includes('id="homepage-health-performance-root"') || !homepage.includes('homepage-health-performance.js?v=20260828-home-top20') || !homepage.includes('homepage-health-performance.css?v=20260828-home-top20')) throw new Error("Homepage must expose the compact health-performance comparison");
if (!homepageScript.includes("slice(0,20)") || !homepageScript.includes('id="hero-compare-country"') || !homepageScript.includes("macro-country-picker") || !homepage.includes("chart-source-hover")) throw new Error("Homepage charts must use Top 20 views, optional comparison countries and hover-revealed sources");
...
if (!homepage.includes('styles-v2.css?v=20260828-home-top20') || !homepage.includes('homepage-v2.js?v=20260828-home-top20') || !homepage.includes('global-nav.js?v=20260824-logo-120') || !homepage.includes('site-header.css?v=20260824-header-lockup')) throw new Error("Homepage assets must be cache-busted for the compact Top 20 release");
