...
if (!homepage.includes('id="category-comparison-root"') || !homepage.includes('homepage-category.js?v=20260828-home-picker') || !homepage.includes('homepage-category.css?v=20260828-home-picker')) throw new Error("Homepage must expose the compact country category comparison");
if (!homepage.includes('id="homepage-health-performance-root"') || !homepage.includes('homepage-health-performance.js?v=20260828-home-picker') || !homepage.includes('homepage-health-performance.css?v=20260828-home-picker')) throw new Error("Homepage must expose the compact health-performance comparison");
if (!homepageScript.includes("slice(0,20)") || !homepageScript.includes('type="search"') || !homepageScript.includes("macro-country-picker") || !homepageScript.includes("meta(code)?.iso2?.toLowerCase()") || !homepage.includes("chart-source-hover")) throw new Error("Homepage charts must use Top 20 views, searchable comparison countries, consistent SVG flags and hover-revealed sources");
...
if (!nginx.includes("global-nav.js?v=20260827-country-methodology") || nginx.includes("global-nav.js?v=20260827-germany-routes") || nginx.includes("global-nav.js?v=20260827-coverage-menu")) throw new Error("Nginx must publish the country-aware methodology navigation under a fresh cache key");
...
if (!homepage.includes('styles-v2.css?v=20260828-home-picker') || !homepage.includes('homepage-v2.js?v=20260828-home-picker') || !homepage.includes('global-nav.js?v=20260824-logo-120') || !homepage.includes('site-header.css?v=20260824-header-lockup')) throw new Error("Homepage assets must be cache-busted for the searchable-country release");
