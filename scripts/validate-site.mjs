...
if (!methodologyPage.includes('class="method-grid-expanded"') || !aboutPage.includes("Hlidac statu, z.u.") || !homepage.includes("data-global-footer") || !internationalMunicipalPage.includes("data-global-footer")) throw new Error("Dedicated methodology, About, and global project credits must be present");
