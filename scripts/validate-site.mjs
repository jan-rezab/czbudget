...
if (!homepage.includes('styles-v2.css?v=20260821-fiscal-scope') || !homepage.includes('homepage-v2.js?v=20260821-fiscal-scope') || !homepage.includes('global-nav.js?v=20260821-city-navigation')) throw new Error("Homepage assets must be cache-busted for the current fiscal-scope release");
