...
if (!homepage.includes('styles-v2.css?v=20260822-brand') || !homepage.includes('homepage-v2.js?v=20260822-international-municipalities') || !homepage.includes('global-nav.js?v=20260822-international-municipalities')) throw new Error("Homepage assets must be cache-busted for the current municipality and brand release");
