...
if (!nginx.includes("global-nav.js?v=20260827-germany-routes") || nginx.includes("global-nav.js?v=20260827-coverage-menu")) throw new Error("Nginx must publish the Germany-aware global navigation under a fresh cache key");
