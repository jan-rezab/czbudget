...
const globalNav = await readFile("global-nav.js", "utf8");
{
  ...
  if (!publicEmploymentDeepDivePage.includes('id="employment-history-chart"') || !publicEmploymentDeepDivePage.includes('id="employment-reconciliation"') || !publicEmploymentDeepDivePage.includes('../../data/cz-public-employment.v1.json')) throw new Error("Public-employment report must expose its history, reconciled workforce model and auditable download");
}
...
for (const path of await htmlFiles()) {
  ...
  if ((page.match(/global-nav\.js\?v=(?:20260822-component|20260824-identity-outlines|20260824-logo-120|20260824-budget-stages|20260825-country-expansion|20260826-migration|20260828-education|20260829-oecd-reports|20260901-trade-menu|20260901-public-employment|20260902-product-markets)/g) || []).length !== 1) throw new Error(`${path}: expected exactly one shared header script`);
