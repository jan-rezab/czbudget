...
if (!homepage.includes('styles-v2.css?v=20260820-cities') || !homepage.includes('homepage-v2.js?v=20260820-cities') || !homepage.includes('global-nav.js?v=20260820-capitals-history')) throw new Error("Homepage assets must be cache-busted for the Czech cities release");
