...
if (!nginx.includes("denmark|finland|france") || !nginx.includes("united-states|brazil|spain|japan|netherlands|norway|greece") || nginx.includes("try_files /countries/$1/index.html =404")) throw new Error("All seventeen countries must use the shared national dashboard route");
