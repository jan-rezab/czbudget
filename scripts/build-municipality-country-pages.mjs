...
<head>
  ...
  <script src="../../municipalities-country.js?v=20260918-chart-integrity" defer></script>
...
const historyChartProfile=germanProfile
  .replaceAll("municipal-expanded-profile.css?v=20260828-fx-currency","municipal-expanded-profile.css?v=20260912-history-chart")
  .replaceAll("municipal-expanded-profile.js?v=20260828-fx-currency","municipal-expanded-profile.js?v=20260912-history-chart");
await writeFile(new URL("../municipalities/germany/profile/index.html",import.meta.url),historyChartProfile);

const frenchProfile=historyChartProfile
