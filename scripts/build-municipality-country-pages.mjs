...
<head>
  ...
  <link rel="stylesheet" href="../../municipalities.css?v=20260822-country-municipalities">
  <link rel="stylesheet" href="../../municipalities-navigator.css?v=20260822-country-municipalities">
  <script src="../../global-nav.js?v=20260822-country-municipalities" defer></script>
  <script src="../../municipalities-country.js?v=20260822-country-municipalities" defer></script>
</head>
<body class="municipalities-page country-municipalities-page" data-country-code="${page.code}" data-country-slug="${slug}">
  <header class="site-header compact-header has-global-nav"><a class="brand" href="../../index.html"><span class="brand-grid" aria-hidden="true"></span><span class="wordmark">Public Spending <b>Data</b></span></a><nav class="global-nav" aria-label="Primary navigation"></nav><div class="lang-switch"><button data-lang="cs" class="active">CS</button><span>/</span><button data-lang="en">EN</button></div></header>
  <main id="top">
