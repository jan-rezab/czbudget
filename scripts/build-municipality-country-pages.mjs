...
<head>
  ...
  <script src="../../municipalities-country.js?v=20260828-france-profiles" defer></script>
...
<body class="municipalities-page country-municipalities-page" data-country-code="${page.code}" data-country-slug="${slug}">
  ...
  <main id="top">
    ...
    <nav class="municipal-rail"><a href="#insights" data-copy="navInsights">Co data říkají</a><a id="budget-structure-nav" href="#budget-structure" data-copy="navStructure" hidden>Struktura rozpočtu</a><a id="tax-autonomy-nav" href="#tax-autonomy">OECD · daňová pravomoc</a><a href="#directory" data-copy="navDirectory">Adresář</a><a href="#context" data-copy="navContext">Kontext a zdroj</a></nav>
    ...
    <section id="directory" class="municipal-section"><div class="section-heading"><div><span class="kicker" data-copy="directoryKicker">Místní úroveň</span><h2 data-copy="directoryTitle">Najděte obec</h2></div><p id="country-directory-count">—</p></div><div class="municipal-controls country-directory-controls"><label><span data-copy="search">Hledat</span><input id="country-municipality-search" type="search" autocomplete="off" data-placeholder="searchPlaceholder" placeholder="Název nebo národní kód…"></label><label><span data-copy="year">Rok</span><select id="country-year-filter"></select></label><button id="country-reset" type="button" data-copy="reset">Vymazat filtry</button></div><div id="country-municipality-grid" class="municipality-grid"></div><button id="country-load-more" class="load-more" type="button" data-copy="more">Načíst další</button></section>
...
const frenchProfile=germanProfile
  ...
  .replaceAll('municipal-expanded-profile.js?v=20260828-fx-currency','municipal-expanded-profile.js?v=20260828-france-profiles')
