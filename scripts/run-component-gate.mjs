...
function registryContracts() {
  return ['tests/unit/chart-explorer.spec.mjs','tests/unit/chart-renderer.spec.mjs','tests/unit/chart-registry.spec.mjs','tests/unit/release-contract.spec.mjs','tests/unit/verification-plan.spec.mjs','tests/unit/verification-plan-sparse.spec.mjs'];
}
