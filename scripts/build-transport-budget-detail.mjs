...
const PUBLIC_DATA = {
  ...
  ESP:{detail_status:"harmonised",level_status:"harmonised",note_cs:"Eurostat zveřejňuje výdaje vládních institucí na dopravu podle ekonomického druhu a subsektoru.",note_en:"Eurostat publishes general-government transport expenditure by economic type and subsector.",next_step_cs:"Doplnit projekty a programy z rozpočtových dat ministerstva dopravy.",next_step_en:"Add projects and programmes from Ministry of Transport budget data.",sources:[{title:"Ministerio de Transportes · economic information",url:"https://www.transportes.gob.es/el-ministerio/informacion-economica"}]},
  ...
  NLD:{detail_status:"harmonised",level_status:"harmonised",note_cs:"Eurostat zveřejňuje konsolidované dopravní výdaje podle ekonomického druhu a subsektoru.",note_en:"Eurostat publishes consolidated transport expenditure by economic type and subsector.",next_step_cs:"Doplnit projekty z Infrastructuurfonds a Deltafonds.",next_step_en:"Add projects from the Infrastructure Fund and Delta Fund.",sources:[{title:"Rijksoverheid · Infrastructure Fund budget",url:"https://www.rijksoverheid.nl/onderwerpen/prinsjesdag/infrastructuurfonds"}]},
