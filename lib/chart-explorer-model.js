...
(function (root) {
  ...
  const defaults = { metric: 'expenditure_pct_gdp', countries: ['CZE', 'DEU', 'GBR', 'USA'], start: 2005, end: 2024, year: 2024, mode: 'level', view: 'line', scale: 'fit' };
  ...
  function build(dataset, input) {
    ...
    return { state, fields, rows, contextRows, snapshot, unit: state.mode === 'change' ? 'Percentage-point change' : '% of GDP' };
  }
