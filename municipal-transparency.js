(() => {
  ...
  const copy = {
    en: {
      mode:"Coverage layer", readiness:"Overall coverage score (PSD)", national:"OBS central-government score", municipal:"Municipal item-level lifecycle",
    ...
    cs: {
      mode:"Vrstva pokrytí", readiness:"Celkové skóre pokrytí (PSD)", national:"Skóre OBS pro centrální vládu", municipal:"Položkový životní cyklus obcí",
