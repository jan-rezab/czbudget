(() => {
  ...
  const names = {
    ...
    FIN:["Finsko","Finland"], GRC:["Řecko","Greece"],
  };
  ...
  const copy = {
    cs:{kicker:"Výdaje podle kategorií",title:"Národní výdajové kategorie ve společném pohledu.",intro:"Národní klasifikace mapujeme na společné kategorie. Podíl se počítá z publikovaného národního součtu, nikoli z HDP; původní částka i zdroj zůstávají zachované.",category:"Kategorie",period:"Období",current:"Aktuální",previous:"Předchozí",scale:"Měřítko",share:"Podíl rozpočtu",eur:"Částka v EUR",leader:"Nejvyšší podíl",median:"Medián zemí",coverage:"Pokrytí",countries:"zemí",matrix:"Celá mapa kategorií",matrixCopy:"Podíl kategorie na součtu publikovaného národního členění. Kliknutím na řádek změníte hlavní srovnání.",profile:"Detail země",sourceLine:"zdrojová položka",mapped:"zdrojových položek",notSeparate:"ve zdroji není samostatně vidět",method:"Jak srovnání vzniká",local:"místní měna",nominal:"nominální",loading:"Načítám srovnání…"},
    en:{kicker:"Spending by category",title:"National spending categories in one comparable view.",intro:"National classifications are mapped to common categories. Shares use each published national total, not GDP; the original amount and source remain visible.",category:"Category",period:"Period",current:"Current",previous:"Previous",scale:"Scale",share:"Budget share",eur:"EUR amount",leader:"Highest share",median:"Country median",coverage:"Coverage",countries:"countries",matrix:"The complete category map",matrixCopy:"Category share of each published national classification total. Select a row to update the main comparison.",profile:"Country profile",sourceLine:"source line",mapped:"source lines",notSeparate:"not separately visible in source",method:"How the comparison is built",local:"local currency",nominal:"nominal",loading:"Loading comparison…"},
  };
  ...
  function render() {
    ...
    const median = shares.length % 2 ? shares[middle] : (shares[middle-1] + shares[middle]) / 2;
