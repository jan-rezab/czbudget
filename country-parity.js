...
const labels={
 cs:{kicker:"Datový kontrakt / úplnost",title:"Načtená data a jejich rozsah",copy:"Každá vrstva drží vlastní rozsah, klasifikaci a fiskální fázi. Chybějící údaj není nula.",loaded:"Načteno",missing:"Chybí",modules:"datových vrstev",download:"Stáhnout profil JSON ↗",municipal:"Otevřít obecní adresář ↗",warehouse:"validovaných finančních řádků",names:{sovereign:"Makro a veřejné finance",baseline_revenue:"Srovnatelné příjmy",baseline_spending:"Srovnatelné výdaje",baseline_unemployment:"Nezaměstnanost",revenue:"Národní detail příjmů",administrative_spending:"Národní výdajová osnova",common_spending:"Srovnatelné kategorie",functional_spending:"Funkční výdaje",transport:"Doprava",health:"Zdravotnictví",providers:"Síť poskytovatelů",municipalities:"Obce",public_entities:"Veřejné subjekty",demography:"Demografie"}},
 en:{kicker:"Data contract / completeness",title:"Loaded data and its scope",copy:"Every layer retains its own scope, classification and fiscal stage. A missing observation is not zero.",loaded:"Loaded",missing:"Missing",modules:"data layers",download:"Download profile JSON ↗",municipal:"Open municipal directory ↗",warehouse:"validated financial rows",names:{sovereign:"Macro and public finance",baseline_revenue:"Comparable revenue",baseline_spending:"Comparable spending",baseline_unemployment:"Unemployment",revenue:"Native revenue detail",administrative_spending:"Native spending classification",common_spending:"Comparable categories",functional_spending:"Functional spending",transport:"Transport",health:"Health",providers:"Provider network",municipalities:"Municipalities",public_entities:"Public entities",demography:"Demography"}}
};
