...
if(!root)return;
const state={data:null,code:window.PSDCountryRoutes.codeFromLocation(),lang:new URLSearchParams(location.search).get("lang")||localStorage.getItem("psd-lang")||"cs"};
const labels={
