(() => {
  ...
  function render() {
    ...
    footer.innerHTML = `<a class="footer-brand" href="${href("index.html")}" aria-label="Public Spending Data"><img src="${assetRoot}assets/logo-lockup-dark.svg" width="190" height="48" alt="Public Spending Data"></a><div class="footer-formalities"><strong>${t.maker}</strong><span>${t.legal}</span><span>${t.address}</span><a href="mailto:info@hlidacstatu.cz">info@hlidacstatu.cz</a></div><a class="footer-hlidac" href="https://www.hlidacstatu.cz/" target="_blank" rel="noopener" aria-label="Hlidac statu, z.u."><img src="${assetRoot}assets/hlidac-statu.png" width="288" height="138" alt=""></a><nav class="footer-links" aria-label="${lang === "en" ? "Project information" : "Informace o projektu"}"><a href="${href("about.html")}">${t.about}</a><a href="${href("methodology.html")}">${t.methodology}</a></nav>`;
  }
