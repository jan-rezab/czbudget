(() => {
  ...
  const copy = {
    cs: {
      ...
      methodKicker:"Jak katalog číst", methodTitle:"Hranice srovnání a výjimky", methodIntro:"Výnosy jsou nejdostupnější společný ukazatel rozsahu. Ani ten však není ekonomicky totožný mezi energetikou, železnicí, poštou a veřejnoprávní televizí.",
      sourceKicker:"Primární dokumenty", sourceTitle:"Odkazy na výroční zprávy a závěrky", sourceIntro:"Odkazy vedou na výroční zprávy, auditované účetní závěrky, výsledkové zprávy a oficiální dokumenty vlastníka. Přepočet používá průměrné kurzy za rok 2024.", fxTitle:"Kurzy a přepočet", fxNote:"Místních jednotek za 1 EUR; průměr roku 2024.", footer:"Státní podniky · oficiální firemní a vládní zdroje",
    ...
    en: {
      ...
      methodKicker:"How to read the catalogue", methodTitle:"Comparison limits and exceptions", methodIntro:"Revenue is the most available common measure of scale. Even so, it is not economically identical across energy, rail, postal services and public broadcasting.",
      sourceKicker:"Primary documents", sourceTitle:"Links to annual reports and financial statements", sourceIntro:"Links lead to annual reports, audited financial statements, results releases and official owner documents. Conversion uses 2024 annual-average exchange rates.", fxTitle:"Rates and conversion", fxNote:"Local-currency units per EUR; 2024 annual average.", footer:"State-owned enterprises · official company and government sources",
