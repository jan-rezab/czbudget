(() => {
  ...
  const copy = {
/* Merge note: retain the newer product-market copy block below as the base.
    cs: { home:"Domů", compare:"Srovnání", map:"Mapa", cities:"Obce a města", country:"Země", deepDives:"Reporty", method:"Pokrytí", about:"O projektu", all:"Všechny profily", allMunicipalities:"Všechny obce", allDeepDives:"Všechny reporty", education:"Školství", educationCopy:"Od ministerstva k typu školy", transport:"Doprava", transportCopy:"Rozpočty, silnice a tempo výstavby", health:"Zdraví", healthCopy:"Financování a kapacita systému", stateCompanies:"Státní podniky", stateCompaniesCopy:"30 podniků, výnosy v EUR", capitalCities:"Hlavní města", capitalCitiesCopy:"Rozpočtové plány, obyvatelé a turistický tlak", revenue:"Kdo financuje stát?", revenueCopy:"Daně, úrovně vlády a transfery", ageing:"Účet stárnutí", ageingCopy:"Projekce a demografická kalkulačka", migration:"Evropská migrace", migrationCopy:"33 zemí, migrační toky a status ochrany", economy:"Ekonomika v kontextu", economyCopy:"Dlouhé řady, hospodářský cyklus a fiskální kontext", money:"Kam šly peníze?", moneyCopy:"Česko a USA: peníze, kupní síla a centrální banky", defense:"Výdaje na obranu", defenseCopy:"17 zemí, % HDP a rozpočtové řádky", taxBurden:"Daňové zatížení", taxBurdenCopy:"Domácnosti, firmy, uhlík a místní pravomoc", redistribution:"Přerozdělení a výsledky", redistributionCopy:"Nerovnost, sociální výdaje, důchody a výsledky", trade:"Zahraniční obchod", tradeCopy:"Dovoz, vývoz, partneři a zboží z UN Comtrade", budgetPlanner:"Plánovač rozpočtu 2027", budgetPlannerCopy:"Změňte návrh a sledujte schodek", czechBudget:"Český státní rozpočet", navigation:"Hlavní navigace", language:"Jazyk", searchCountry:"Hledat zemi", searchMunicipality:"Hledat obecní zemi", searchCountryPlaceholder:"Název země…", countryMatches:"profilů", municipalityMatches:"zemí", noCountryMatches:"Žádná země neodpovídá." },
    en: { home:"Home", compare:"Compare", map:"Map", cities:"Municipalities", country:"Country", deepDives:"Reports", method:"Coverage", about:"About", all:"All profiles", allMunicipalities:"All municipalities", allDeepDives:"All reports", education:"Education", educationCopy:"From ministry to school type", transport:"Transportation", transportCopy:"Budgets, roads and build pace", health:"Health", healthCopy:"Funding and system capacity", stateCompanies:"State-owned enterprises", stateCompaniesCopy:"30 enterprises, revenue in EUR", capitalCities:"Capital cities", capitalCitiesCopy:"Budget plans, residents and visitor pressure", revenue:"Who funds the state?", revenueCopy:"Taxes, government levels and transfers", ageing:"The Ageing Bill", ageingCopy:"Projections and demographic calculator", migration:"European migration", migrationCopy:"33 countries, migration flows and protection status", economy:"Economy in context", economyCopy:"Long-run series, the economic cycle and fiscal context", money:"Where did the money go?", moneyCopy:"Czechia and the US: money, purchasing power and central banks", defense:"Defense spending", defenseCopy:"17 countries, % of GDP and budget lines", taxBurden:"Tax burden", taxBurdenCopy:"Households, companies, carbon and local authority", redistribution:"Redistribution and outcomes", redistributionCopy:"Inequality, social spending, pensions and outcomes", trade:"Foreign trade", tradeCopy:"Imports, exports, partners and goods from UN Comtrade", budgetPlanner:"2027 budget planner", budgetPlannerCopy:"Change the proposal and track the deficit", czechBudget:"Czech state budget", navigation:"Primary navigation", language:"Language", searchCountry:"Search countries", searchMunicipality:"Search municipality countries", searchCountryPlaceholder:"Country name…", countryMatches:"profiles", municipalityMatches:"countries", noCountryMatches:"No countries match." },
*/
    cs: { home:"Domů", compare:"Srovnání", map:"Mapa", cities:"Obce a města", country:"Země", deepDives:"Reporty", method:"Pokrytí", about:"O projektu", all:"Všechny profily", allMunicipalities:"Všechny obce", allDeepDives:"Všechny reporty", education:"Školství", educationCopy:"Od ministerstva k typu školy", transport:"Doprava", transportCopy:"Rozpočty, silnice a tempo výstavby", health:"Zdraví", healthCopy:"Financování a kapacita systému", stateCompanies:"Státní podniky", stateCompaniesCopy:"30 podniků, výnosy v EUR", capitalCities:"Hlavní města", capitalCitiesCopy:"Rozpočtové plány, obyvatelé a turistický tlak", revenue:"Kdo financuje stát?", revenueCopy:"Daně, úrovně vlády a transfery", ageing:"Účet stárnutí", ageingCopy:"Projekce a demografická kalkulačka", migration:"Evropská migrace", migrationCopy:"27 zemí, příchody, odchody a saldo", economy:"Ekonomika v kontextu", economyCopy:"Dlouhé řady, hospodářský cyklus a fiskální kontext", money:"Kam šly peníze?", moneyCopy:"Česko a USA: peníze, kupní síla a centrální banky", defense:"Výdaje na obranu", defenseCopy:"17 zemí, % HDP a rozpočtové řádky", taxBurden:"Daňové zatížení", taxBurdenCopy:"Domácnosti, firmy, uhlík a místní pravomoc", redistribution:"Přerozdělení a výsledky", redistributionCopy:"Nerovnost, sociální výdaje, důchody a výsledky", trade:"Zahraniční obchod", tradeCopy:"Dovoz, vývoz, partneři a zboží z UN Comtrade", productMarkets:"Globální produktové trhy", productMarketsCopy:"HS6 původ, dovozní trhy a bilaterální toky", budgetPlanner:"Plánovač rozpočtu 2027", budgetPlannerCopy:"Změňte návrh a sledujte schodek", czechBudget:"Český státní rozpočet", navigation:"Hlavní navigace", language:"Jazyk", searchCountry:"Hledat zemi", searchMunicipality:"Hledat obecní zemi", searchCountryPlaceholder:"Název země…", countryMatches:"profilů", municipalityMatches:"zemí", noCountryMatches:"Žádná země neodpovídá." },
    en: { home:"Home", compare:"Compare", map:"Map", cities:"Municipalities", country:"Country", deepDives:"Reports", method:"Coverage", about:"About", all:"All profiles", allMunicipalities:"All municipalities", allDeepDives:"All reports", education:"Education", educationCopy:"From ministry to school type", transport:"Transportation", transportCopy:"Budgets, roads and build pace", health:"Health", healthCopy:"Funding and system capacity", stateCompanies:"State-owned enterprises", stateCompaniesCopy:"30 enterprises, revenue in EUR", capitalCities:"Capital cities", capitalCitiesCopy:"Budget plans, residents and visitor pressure", revenue:"Who funds the state?", revenueCopy:"Taxes, government levels and transfers", ageing:"The Ageing Bill", ageingCopy:"Projections and demographic calculator", migration:"European migration", migrationCopy:"27 countries, arrivals, departures and balance", economy:"Economy in context", economyCopy:"Long-run series, the economic cycle and fiscal context", money:"Where did the money go?", moneyCopy:"Czechia and the US: money, purchasing power and central banks", defense:"Defense spending", defenseCopy:"17 countries, % of GDP and budget lines", taxBurden:"Tax burden", taxBurdenCopy:"Households, companies, carbon and local authority", redistribution:"Redistribution and outcomes", redistributionCopy:"Inequality, social spending, pensions and outcomes", trade:"Foreign trade", tradeCopy:"Imports, exports, partners and goods from UN Comtrade", productMarkets:"Global product markets", productMarketsCopy:"HS6 origins, import markets, and bilateral flows", budgetPlanner:"2027 budget planner", budgetPlannerCopy:"Change the proposal and track the deficit", czechBudget:"Czech state budget", navigation:"Primary navigation", language:"Language", searchCountry:"Search countries", searchMunicipality:"Search municipality countries", searchCountryPlaceholder:"Country name…", countryMatches:"profiles", municipalityMatches:"countries", noCountryMatches:"No countries match." },
  };
  ...
  Object.assign(copy.cs,{digitalSpillover:"Digitální hodnota",digitalSpilloverCopy:"10 zemí, únik a domácí reinvestice"});
  Object.assign(copy.en,{digitalSpillover:"Digital value",digitalSpilloverCopy:"10 countries, leakage and domestic reinvestment"});
  Object.assign(copy.cs,{euBudget:"Peníze země ↔ EU",euBudgetCopy:"27 zemí, příspěvky a přiřazené výdaje"});
  ...
  Object.assign(copy.cs,{industrialDiagnostics:"Uvnitř průmyslu",industrialDiagnosticsCopy:"Firemní investice, kapacity, výrobky a výrobní řetězce",industry:"Průmysl měsíc po měsíci",industryCopy:"Odvětví, měsíční a roční vývoj, národní zdroje i Eurostat"});
  Object.assign(copy.en,{industrialDiagnostics:"Inside industry",industrialDiagnosticsCopy:"Business investment, factory capacity, products and value chains",industry:"Industry month by month",industryCopy:"Sectors, monthly and annual trends, national sources and Eurostat"});
...
*/
      ...
      nav.querySelector(".deep-dive-menu-panel")?.insertAdjacentHTML("beforeend", `<a href="${assetRoot}deep-dives/industry/diagnostics/?lang=${lang}"><b>23</b><span><strong>${t.industrialDiagnostics}</strong><small>${t.industrialDiagnosticsCopy}</small></span></a>`);
