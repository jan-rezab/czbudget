(() => {
  ...
  class PsdSiteHeader extends HTMLElement {
    ...
    renderNavigation() {
      ...
      nav.querySelector(".deep-dive-menu-panel")?.insertAdjacentHTML("beforeend", `<a href="${assetRoot}deep-dives/defense/?code=USA&lang=${lang}"><b>09</b><span><strong>${t.defense}</strong><small>${t.defenseCopy}</small></span></a>`);
